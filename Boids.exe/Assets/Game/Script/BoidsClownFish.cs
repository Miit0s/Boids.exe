...
public class BoidsClownFish : MonoBehaviour
{
    ...
    public List<BoidsClownFish> newPack = new List<BoidsClownFish>(); //A changer
    bool finTemps;
    bool uneFois = false;
    ...
    void Update()
    {
        ...
        if (finTemps == false)
        {
            foreach (BoidsClownFish otherBoid in BoidsManagerClownFish.sharedInstanceClownFish.roBoids) //A changer
            {
        ...
        else
        {
            if (uneFois == true)
            {
                foreach (BoidsClownFish Boids in BoidsManagerClownFish.sharedInstanceClownFish.roBoids) //A changer
                {
            ...
            foreach (BoidsClownFish otherBoid in newPack) //A changer
            {
                Vector3 vecToOtherBoid = otherBoid.transform.position - transform.position;
    ...
    private void ChooseTarget(List<BoidsClownFish> boids) //A changer
    {
        ...
        foreach (BoidsClownFish b in boids) //A changer
        {
            b.goToTarget = false;
